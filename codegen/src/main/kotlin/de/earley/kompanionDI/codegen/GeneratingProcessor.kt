...
abstract class GeneratingProcessor : AbstractProcessor() {
    ...
    protected val processors: MutableMap<KClass<out Annotation>, (Set<Element>) -> Unit> = HashMap()

    protected inline fun <reified T : Annotation> process(noinline f: (Set<Element>) -> Unit) {
    ...
    override fun process(annotations: MutableSet<out TypeElement>, roundEnv: RoundEnvironment): Boolean {
        ...
        processors.forEach { (type, func) ->
            ...
            func(roundEnv.getElementsAnnotatedWith(type.java))
        }
